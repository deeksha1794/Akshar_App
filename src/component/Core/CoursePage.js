...
render()
    ...
    const users = [
      {
         ...
         screens:{
           ...
           onPress={()=>this.props.navigation.navigate("Course",{textView:(
             <View >
             <View>
  ...
  The defaultthis.props is defined as a property of Component to define all the default value of this.props, which can be overridden with new prop values.
  ...
  <View style={styles.imageViews}>
                ...
                state and this.props, our React Component is ready to mount in the browser DOM. 
           ...
           raised
            titleStyle={styles.titleStyle}
             title={'Basic Level'}
              buttonStyle={styles.button}
               onPress={()=>this.props.navigation.navigate("Quizs",{Quiz:[{question:'Everything in React is a __________',
             ...
             />)},
                 ...
                 answer:(<RadioForm
                  radio_props={[
                   {label: 'A transpiler ', value: 'A transpiler ' },
                   {label: 'A compiler ', value: 'A compiler ' },
                   {label: 'Both compiler and transpiler  ', value: 'Both compiler and transpiler  ' }
                ...
                answer:(<RadioForm
                 radio_props={[
                  {label: 'Server side Framework  ', value: 'Server side Framework  ' },
                  {label: 'User-interface Framework  ', value: 'User-interface Framework  ' },
                  {label: 'A library for building interaction interface   ', value: 'A library for building interaction interface  ' }
                ]}
                initial={-1}
                 onPress={(value) => {this.setState({value:value})}}
               />)},
               {question:'What are the two ways that get handled in React ',
               answer:(<RadioForm
                radio_props={[
                 {label: 'State and props ', value: 'State and props  ' },
                 {label: 'Services and components  ', value: 'Services and components  ' }
               ]}
               initial={-1}
                onPress={(value) => {this.setState({value:value})}}
              />)},
              ...
              answer:(<RadioForm
               radio_props={[
                ...
                {label: 'render with arguments  ', value: 'render with arguments  ' },
                {label: 'PropTypes  ', value: 'PropTypes   ' },
       ...
       <View style={styles.card}>
  {
    ...
    (
        <TouchableOpacity 
        key={i} 
        onPress={() => { navigate('Course_Board',{itemName:u.name,itemIcon:u.icon,itemScreen:u.screens}) }}
        style={styles.col}
